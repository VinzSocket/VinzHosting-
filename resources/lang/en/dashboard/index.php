...
return [
    ...
    'source-codes' => [
        'title' => 'Source Code',
        'subtitle' => 'Source code and tools shared by the panel admin.',
        'view' => 'View',
        'no-description' => 'No description provided.',
        'change-style' => 'Change button style',
        'style-modal' => [
            'title' => 'Choose Button Style',
            'description' => 'Pick how the download buttons look. You can change this anytime.',
            '3d' => '3D',
            'normal' => 'Normal',
        ],
    ],
